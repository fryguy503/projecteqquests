-- Event controller (162255) in Ssra
...
function event_timer(e)
    ...
    if e.timer == 'glyphed' then
        eq.unique_spawn(162261, 0, 0, -38, -10, -222); -- spawn glyphed
        reset();
    elseif e.timer == 'runed' then
        eq.unique_spawn(162253, 0, 0, -38, -10, -222); -- spawn runed
        reset();
    end
end
...
function event_say(e)
    if e.other:Admin() > 100 then
        ...
        elseif(e.message:findi("respawn")) then
            reset()
            local trigger_spawns = {[162023]=34235, [162059]=352952, [162060]=33963, [162011]=33884, [162012]=33885, [162021]=33891, [162024]=33895, [162013]=33886, [162089]=34043, [162258]=37145}
