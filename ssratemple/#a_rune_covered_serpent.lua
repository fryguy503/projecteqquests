-- a rune covered serpent (162253) for Cursed cycle in Ssratemple
...
function event_death_complete(e)
    ...
    if tonumber(qglobals['cursed_progress']) == 1 then
        eq.unique_spawn(162232, 0, 0 , -38, -10, -222) -- spawn Vyzh`dra the Exiled if he hasn't been killed in this cycle
    elseif tonumber(qglobals['cursed_progress']) < 3 then
        eq.unique_spawn(162214, 0, 0 , -38, -10, -222) -- spawn Vyzh`dra the Banished if Exiled has been killed
    else
    end
end
